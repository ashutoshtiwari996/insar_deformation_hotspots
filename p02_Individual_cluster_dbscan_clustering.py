...
tskmeans=spio.loadmat(ppath+'/radheshyam_predicted_ts_clusters_frame5.mat')
...
mvel_full=np.hstack((mvel1_filtered, mvel2_filtered, mvel3_filtered, mvel4_filtered))
...
spio.savemat(ppath+'/output_dbscan_frame4.mat', {"mvel_full":mvel_full, "rs_db_full":rs_db_full, "lonlat_full": lonlat_full, "y_predn_full": y_predn_full, "rs_full": rs_full, "lonlat":lonlat});
