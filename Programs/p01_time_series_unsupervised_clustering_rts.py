...
dpath='/media/ashutosh/Data/Project02_LosAngeles/Features'

#reading dataset

ts_parameters=mat73.loadmat(dpath+'/R_TS_den.mat')

static_parameters=spio.loadmat(dpath+'/static_parameters.mat')
...
mvel=static_parameters['MVel'].astype('float16') #mean LOS velocity

mvelq=static_parameters['MVelq'].astype('float16') #mean LOS velocity

inc_angle=static_parameters['inc_angle'].astype('float16') #containe lat lon and incidence angle
